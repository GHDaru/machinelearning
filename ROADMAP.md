...
| **D11** | **14 objetivos sem exercício próprio** — eram 20 em 2026-08-12, e não 2, como esta linha declarou até então | achado pela auditoria de Bloom. O gate do `exercicios.mjs` **cobra**: órfão novo quebra o build, e a exceção tem de sair da lista no mesmo commit em que a dívida é paga. **Seis pagos no 1º lote do [ADR 0012](adr/0012-verificacao-como-superficie-corrigida.md)** (`0-2`, `i-2`, `i-3`, `i-4`, `i-5`, `i-6`) |
