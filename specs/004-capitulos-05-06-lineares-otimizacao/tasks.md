...
- [x] **T403** `RegressaoLinear` por gradiente, convergindo ao mesmo ponto · *verif.:* Δ < 0,05
- [x] **T404** `RegressaoLogistica` com L1, L2 e razão de chances · *verif.:* 4 testes
- [x] **T405** `descida_de_gradiente` isolado, com lote/mini-batch/estocástico · *verif.:* 3 testes
- [x] **T406** `Historico` com `divergiu()` e `estagnou()` · *verif.:* 3 testes
