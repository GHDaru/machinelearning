"""LLMPort — a porta do modelo.

Um Protocol e dois adapters: `echo` (sem rede, para dev e testes) e qualquer
endpoint OpenAI-compatible. O modelo fica atrás desta porta para que trocá-lo
não toque em nada além deste arquivo.

O **BYOK** (bring your own key) permite ao leitor passar a própria chave numa
requisição; ela é usada só naquela chamada e **nunca** persistida nem logada
(Princípio V — credencial é credencial).
"""
