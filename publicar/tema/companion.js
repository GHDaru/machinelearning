    ...
    if (mPlano) {
      ...
      api("/objetivo", { method: "POST", headers: { "content-type": "application/json" },
        ...
        .then(function () {
          ...
          sendMsg("Meu objetivo é: " + objetivo + ". Trace um plano de ensino por este livro para mim (ordem de capítulos, quais exercícios praticar, que etapas do ml-zero fazer e por onde começar hoje).");
        });
      return;
    }
