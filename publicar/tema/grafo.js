...
(function () {
  ...
  var CORES = { capitulo: "#e0a24a", conceito: "#6fd08a", etapa: "#c79be0" };
  var NOMES = { capitulo: "Capítulos", conceito: "Conceitos", etapa: "ml-zero" };
  var RAIO = { capitulo: 11, conceito: 8, etapa: 6 };
  ...
  function iniciar(g) {
    ...
    var visiveis = { capitulo: true, conceito: true, etapa: true };
