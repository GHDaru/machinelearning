# Skills de processo (padrão agentskills.io)

> Herdadas do [Maestro](https://github.com/GHDaru/maestro), que é onde elas nasceram e onde evoluem. Aqui elas valem como enforcement do processo de desenvolvimento (constituição, "Fluxo de trabalho e portões de qualidade"). Os *Princípios I–VII* citados nas tabelas abaixo referem-se à constituição do Maestro; neste repositório a referência é a [constituição local](../.specify/memory/constitution.md), de nove princípios.
