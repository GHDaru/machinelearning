...
`R² = 0,982` é excelente e não prova nada sobre generalização: não há divisão treino/teste aqui, e o dado é sintético. Serve para introduzir o que os capítulos [0.2](../../../livro/0-2-fundamentos.md) e [II.1](../../../livro/capitulos/ii-1-avaliacao.md) cobram — divisão honesta e métrica fora da amostra.
